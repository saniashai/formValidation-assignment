...
const SignUpForm = () => {
    ...
    return (
        <div style={{ backgroundColor: 'skyblue', height: '100vh' }} className="d-flex justify-content-center align-items-center">
            <div className="card shadow" style={{ width: '25rem', backgroundColor: 'lightpink' }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='mt-4 text-center'>
                            <button 
                                type="submit" 
                                className="btn" 
                                style={{ backgroundColor: 'green', color: 'white', width: '50%', marginBottom: '1rem', padding: '0.5rem' }}>
                                Register
                            </button>
                        </div>
                    </form>
